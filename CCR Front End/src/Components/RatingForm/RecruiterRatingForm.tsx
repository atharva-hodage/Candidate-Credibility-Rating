...
const RecruiterRatingForm = () => {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:8080/getAllQuestion")
      .then((response) => {
  ...
  const saveResponses = () => {
    ...
    axios
      .post(
        `http://localhost:8080/submitAnswers?candidateId=${candidateId}&recruiterId=${recruiterId}&jobRole=${jobRole}`,
        formattedAnswers,
        {
          headers: {
      ...
      .then((response) => {
        ...
        if (comment) {
          axios
            .post(
              `http://localhost:8080/submitComment?candidateId=${candidateId}&recruiterId=${recruiterId}`,
        ...
        axios
          .post(`http://localhost:8080/getCandidateScoreRecruiter`, {
        ...
        alert("Response for the candidate has been saved.");
      })
